...
class PrintPreview:
    ...
    def __init__(self, l, tit, subtitle, col=4, tsize=20, subsize=11, csize=11,
                # 默认输出文件地址为项目根目录 
    ...
    def create_psmdocx(self, l, title, docxname):
        ...
        table.style.font.color.rgb = RGBColor(54,54 0)  # 颜色设置，这里是用RGB颜色
        table.style.font.size = Pt(self.p_content_size)  # 字体大小设置，和word里面的字号相对应
